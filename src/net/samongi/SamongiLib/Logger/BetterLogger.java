...
public class BetterLogger
{
  ...
  public void log(Level level, String message, Object param1)
  {
    ...
    this.logger.log(Level.INFO, this.prefix(level, message), param1);
  }

  public void log(Level level, String message, Object... params)
  {
    if (!shouldLog(level)) return;
    this.logger.log(Level.INFO, this.prefix(level, message), params);
  }

  public void log(Level level, String message)
  {
    if (!shouldLog(level)) return;
    this.logger.log(Level.INFO, this.prefix(level, message));
  }
  ...
  {
    this.severe(message);
    if (err != null) this.severe(err.getMessage());
  }
  ...
  public void warning(String message, Exception err)
  {
    ...
    if (err != null) this.warning(err.getMessage());
  }
